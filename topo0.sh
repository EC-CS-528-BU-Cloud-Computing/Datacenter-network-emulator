...
ip netns exec srv1 ip addr add 10.0.1.1/24 dev lo
...
ip netns exec srv0 ip addr add 10.0.0.2/24 dev veth0p
ip netns exec srv1 ip addr add 10.0.1.2/24 dev veth1p
...
ip addr add 10.0.2.254/24 dev sw
bridge link
...
# Test
# ip netns exec srv0 ping 10.0.1.1
# ip netns exec srv0 ping 10.0.0.1